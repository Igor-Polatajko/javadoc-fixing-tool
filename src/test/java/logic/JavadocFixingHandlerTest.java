...
public class JavadocFixingHandlerTest {
    ...
    @Test
    public void fixParamStatements_varargs() {
        String testValue = "/**\n" +
                "     * Text\n" +
                "     * @param ints\n" +
                "     */";
        ...
        String expectedValue = "/**\n" +
                "     * Text\n" +
                "     * @param args - the args (varargs of type String)\n" +
                "     * @param ints - the ints (varargs of type Integer)\n" +
                "     */";

        MethodDescription testMethodDescription = new MethodDescription();
        testMethodDescription.setParams(Arrays.asList("String... args", "Integer... ints"));
    ...
    @Test
    public void fixParamStatements_paramNameInsideParentheses() {
        String testValue = "/**\n" +
                "     * Text\n" +
                "     * @param (integer) - some desc\n" +
                "     * @param (string)\n" +
                "     * @param (Class) - class\n" +
                "     */";
        ...
        String expectedValue = "/**\n" +
                "     * Text\n" +
                "     * @param class - the class (Class)\n" +
                "     * @param integer - some desc\n" +
                "     * @param string - the string (String)\n" +
                "     */";

        MethodDescription testMethodDescription = new MethodDescription();
        testMethodDescription.setParams(Arrays.asList("Integer integer", "String string", "Class class"));
